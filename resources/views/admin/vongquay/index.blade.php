            ...
            <div class="card">
              ...
              <form class="form-inline" action="/action_page.php" style="padding: 10px;border-bottom: 1px solid #dee2e6">
                <div class="form-group" style="padding: 5px;">
                  ...
                  <input type="number" placeholder="Tên đăng nhập..." class="form-control" id="email">
                </div>
                <div class="form-group" style="padding: 5px;">
                  <label style="border: 1px solid #ced4da;padding:10px 3px;" for="pwd"><i class="fa fa-calendar"></i></label>
                  <input type="date" placeholder="Từ ngày" class="form-control" id="pwd">
                </div> 
                <div class="form-group" style="padding: 5px;">
                  <label style="border: 1px solid #ced4da;padding:10px 3px;" for="pwd"><i class="fa fa-calendar"></i></label>
                  <input type="date" placeholder="Đến ngày" class="form-control" id="pwd">
                </div> 
                <br> 
