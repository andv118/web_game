...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Liên Quân</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Tài khoản game</a></li>
              <li class="breadcrumb-item active">Liên Quân</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><i class="fa fa-list"></i> Danh sách tài khoản Liên Quân (<span style="color: red;">{{number_format($total)}}</span>)</h3>
              ...
              <div class="card-body table-responsive p-0">
                  <table class="table table-hover table-bordered">
                    <thead>
                      <tr>
                        ...
                        <th colspan="1" style="text-align: center;">Rank</th>
                  ...
                  <div class="justify-panel" style="margin: 30px 0;display: flex;justify-content: center;align-items: center;">
                   {{$lienquan->appends(request()->query())->links()}}
                 </div>
      ...
      <div class="modal-dialog" style="margin-left: 22%;">
        ...
        <div class="modal-content" style="width: 900px;">
            <div class="modal-header">
              <h4 class="modal-title">Thêm tài khoản Liên Quân</h4>
            </div>
