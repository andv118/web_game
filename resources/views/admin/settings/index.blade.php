              ...
              <div class="card-body table-responsive p-0">
                <form method="POST" action="{{Route('admin.save_settings')}}" accept-charset="UTF-8" class="form-horizontal form-charge" style="padding-left: 25%;padding-top: 30px;">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input class="form-control c-square c-theme " name="name" type="text"
                      required placeholder="Tên của trang web" value="{{$data['0']}}">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input class="form-control c-square c-theme " name="email" type="text" maxlength="32"
                      required placeholder="Email liên hệ" value="{{$data['3']}}">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input class="form-control c-square c-theme " name="facebook" type="text"
                      required placeholder="Link Page Facebook" value="{{$data['4']}}">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input class="form-control c-square c-theme " name="youtube" type="text"
                      required placeholder="Link kênh Youtube" value="{{$data['5']}}">
                  ...
                  <div class="form-group c-margin-t-40">
                    <div class="col-md-offset-3 col-md-6">
                      <button 
                      class="btn btn-success" type="submit" data-loading-text="<i class='fa fa-spinner fa-spin '></i>"><i class="fas fa-cog"></i> Lưu cài đặt
                    </button>
