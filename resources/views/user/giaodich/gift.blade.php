...
<div class="container">
    ...
    <div class="c-layout-sidebar-content ">
        ...
        <div class="c-content-title-1">
            <h3 class="c-font-uppercase c-font-bold">Lịch sử nhận quà</h3>
            <div class="c-line-left"></div>
        </div>
        <!-- END: TITLE -->

        <!-- BEGIN: FORM SEARCH -->
        <form action="{{Route('giao-dich.qua-tang.search')}}" class="form-horizontal form-find m-b-20" role="form" method="GET">
            {{ csrf_field() }}
            <div class="row">
