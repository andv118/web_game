...
<div class="c-layout-page">
	<div class="c-size-lg c-overflow-hide c-bg-white font-roboto">
		...
		<div class="text-center" style="margin-bottom: 50px;">
			<h2 style="font-size: 30px;font-weight: bold;text-transform: uppercase">DỊCH VỤ UP BÍ KÍP</h2>
		...
		<div class="container detail-service">
			<div class="col-md-7" style="margin-bottom:20px;">
				<div class="row-flex-safari service-info">
					...
					<div class="col-md-5 hidden-xs hidden-sm">
						<div class="row">
							<div class="news_image">
								<img src="public/client/assets/images/B5xZVs0CHb_1560575840.jpg" alt="Bán vàng">
							</div>
						</div>
						<div class="row">
							<p style="margin-top: 15px" class="bb"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>Up bí kíp</p>
					...
					<div class="col-md-7">
						<form id="thanhtoan_banvang" method="POST" action="{{Route('dichvu.ngocrong.bi-kip-pay')}}" accept-charset="UTF-8" class="">
							{{ csrf_field() }}
			...
			<div class="col-md-5">
				...
				<div class="row emply-btns box-body" style="color: #505050;padding:20px;line-height: 2;margin-top: 30px">
					...
					<p><span style="color:#e74c3c"><strong>- Yêu cầu</strong></span> : 1 set hồi hp(máu) 50% - 60% cho Sư Phụ và 20 ngọc xanh</p>

					<p><span style="color:#e74c3c"><strong>- Thời gian</strong></span> : Up từ 7 ngày - 10 ngày</p>

					<p><span style="color:#e74c3c"><strong>- Lưu ý </strong></span>: Nghiêm cấm vào acc trong thời gian up để tránh bị trì hoãn quá trình úp.</p>
				</div>
