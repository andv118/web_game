...
<script>
	$(document).ready(function() {
		...
		$('select[name="server"]').change(function() {
			var server = $(this).val();
			if (server == 8) {
				$('#txtDiscount').val(1000);
			} else {
				$('#txtDiscount').val(3500);
			}
			updateMoney();
		});
			...
			<div class="col-md-7" style="margin-bottom:20px;">
				<div class="row-flex-safari service-info">
					...
					<div class="col-md-5 hidden-xs hidden-sm">
						...
						<div class="row">
							<p style="margin-top: 15px" class="bb"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>Bán vàng tự động</p>
					...
					<div class="col-md-7">
						<form id="thanhtoan_banvang" method="POST" action="{{Route('dichvu.ngocrong.ban-vang-pay')}}" accept-charset="UTF-8" class="">
							{{ csrf_field() }}
							...
							<div class="mb-15">
								<input name="price" autofocus="" value="20000" class="form-control t14 price " id="input_pack" type="text" placeholder="Số tiền">
								<span style="font-size: 14px;">Số tiền thanh toán phải từ <b style="font-weight:bold;">20,000đ</b> đến <b style="font-weight:bold;">500,000đ</b> </span>
							</div>

							<span class="mb-15 control-label bb">Hệ số:</span>
							<div class="mb-15">
								<input type="text" id="txtDiscount" class="form-control t14" placeholder="" value="3500" readonly="">
							</div>
				...
				<div class="row emply-btns">
					<div class="col-md-8 col-md-offset-2">
						<div class=" emply-btns text-center">
							...
							<a id="txtPrice" style="font-size: 20px;font-weight: bold" class="">Tổng: <span id="money" class="price"> 70000000 </span> Vàng</a>
							@if(Auth::check())
