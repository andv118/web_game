...
<div class="c-layout-page">
	<div class="c-size-lg c-overflow-hide c-bg-white font-roboto">
		...
		<div class="text-center" style="margin-bottom: 50px;">
			<h2 style="font-size: 30px;font-weight: bold;text-transform: uppercase">DỊCH VỤ LÀM NHIỆM VỤ</h2>
		...
		<div class="container detail-service">
			<div class="col-md-7" style="margin-bottom:20px;">
				<div class="row-flex-safari service-info">
					...
					<div class="col-md-5 hidden-xs hidden-sm">
						<div class="row">
							<div class="news_image">
								<img src="public/client/assets/images/m4lJ0Vkd2L_1560575828.jpg" alt="Bán vàng">
							</div>
						</div>
						<div class="row">
							<p style="margin-top: 15px" class="bb"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>Làm nhiệm vụ</p>
					...
					<div class="col-md-7">
						<form id="thanhtoan_banvang" method="POST" action="{{Route('dichvu.ngocrong.nhiem-vu-pay')}}" accept-charset="UTF-8" class="">
							{{ csrf_field() }}
							...
							<div class="simple-checkbox s-filter">
								...
								<p>
									...
									<label for="1">Tiêu Diệt Fide ( yêu cầu : nm 300k ki. xd 300k hp chưa item. td 15k sd có item ) - 150,000 VNĐ</label>
								</p>
								<p>
									<input value="2" type="checkbox" id="2">
									<label for="2">Apk 19 20 ( yêu cầu : nm 300k ki. xd 300k hp chưa item. td 15k sd có item ) - 100,000 VNĐ</label>
								</p>
								<p>
									<input value="3" type="checkbox" id="3">
									<label for="3">Apk 13 14 15 ( yêu cầu : nm 300k ki. xd 300k hp chưa item. td 15k sd có item ) - 100,000 VNĐ</label>
								</p>
								<p>
									<input value="4" type="checkbox" id="4">
									<label for="4">Pick -king kong ( yêu cầu : nm 500k ki. xd 500k hp chưa item. td 20k sd có item ) - 200,000 VNĐ</label>
								</p>
								<p>
									<input value="5" type="checkbox" id="5">
									<label for="5">xbh1 -xht ( yêu cầu : nm 700k ki. xd 700k hp chưa item. td 40k sd có item ) - 400,000 VNĐ</label>
								</p>
							</div>
			...
			<div class="col-md-5">
				...
				<div class="row emply-btns box-body" style="color: #505050;padding:20px;line-height: 2;margin-top: 30px">
					...
					<p><span style="color:#2ecc71"><strong>Hệ thống nhận l&agrave;m nhiệm vụ ch&iacute;nh tuyến game ngọc rồng</strong></span></p>

					<p>Với phương ch&acirc;m :&nbsp;&nbsp;<strong>Gi&aacute; cả hợp l&yacute; - tốc độ&nbsp;nhanh gọn- Chuy&ecirc;n nghiệp</strong></p>

					<p><strong>Thời gian l&agrave;m</strong>&nbsp;&nbsp;:<span style="color:#000000">T&ugrave;y từng nhiệm vụ m&agrave; thời gian kh&aacute;c nhau</span></p>

					<p><strong>Lưu &yacute;&nbsp;</strong>: <span style="color:#000000">Nghi&ecirc;m cấm v&agrave;o acc trong thời gian up để tr&aacute;nh bị delay</span></p>

					<p><strong><span style="color:#000000">Hãy&nbsp;</span>Chuẩn Sẵn&nbsp;&nbsp;50 ngọc để tốc độ l&agrave;m được nhanh nhất</strong></p>
				</div>
			</div>
		</div>
	</div>
