...
<div class="c-layout-page">
	<div class="c-content-box c-size-lg c-overflow-hide c-bg-white font-roboto">
		...
		<div class="c-content-title-1 pd50">
			<h3 class="c-center c-font-uppercase c-font-bold">Vòng Quay Vàng 20k </h3>
            				    ...
            				    <div class="item item-left">
	            					<section class="rotation">
	            						<div class="play-spin">
	            							...
	            							<img style="width: 80%;max-width: 80%;opacity: 1;" src="public/client/assets/home/vong-quay/image/vongquay20k.jpg" alt="Play" id="rotate-play">  
	            						</div>
	            						<div class="text-center">           
	            							<h3 class="num-play"><?php if(Auth::check()) :?>Bạn còn <span>{{Auth::user()->point_20}}</span> lượt quay.<?php endif; ?></h3>
	            							<li>
	            								<?php if(Auth::check()) :?>
	            									<?php if(Auth::user()->cash >= 20000) : ?>
            	...
            	<div class="modal fade" id="modalBuy" role="dialog" aria-hidden="true">
            		<div class="modal-dialog" role="document">
            			<div class="modal-content">
            				<form method="POST" action="{{Route('buy_vong_quay_20k')}}" accept-charset="UTF-8" class="form-horizontal" id="mua">
            					{{csrf_field()}}
            					<div class="modal-header">
            						<h5 class="modal-title" id="exampleModalLabel">Bạn muốn mua thêm lượt quay?</h5>
            					</div>
            					<div class="modal-body">
            						Một lượt quay có giá 20k, vui lòng bấm vào nút xác nhận để hoàn tất thanh toán
            					</div>
            		...
            		<div class="modal-dialog" role="document">
            			<div class="modal-content">
            				...
            				<div class="modal-body" style="font-family: helvetica, arial, sans-serif;">
            					...
            					<p><span style="font-size:20px"><strong>Giá 1 Lần Quay 20k - Khi có đủ 20K anh em chỉ&nbsp;cần nhấp&nbsp;QUAY là sẽ&nbsp;QUAY!&nbsp;<br>
            					Quay Trúng vàng&nbsp;ae vô&nbsp;</strong></span><span style="font-size:24px"><strong><a href="https://shophano.com/user/withdrawservice/237694"><span style="color:#8e44ad">Đây</span></a></strong></span><span style="font-size:20px"><strong>&nbsp;để nhận.</strong></span></p>

            					<p><span style="font-size:20px"><span style="color:#ff0000"><strong>Vàng&nbsp;ngẫu nhiên</strong></span><strong>: Là một số lượng vàng ngẫu nhiên.</strong></span></p>

            					<p><span style="font-size:20px"><span style="color:#ff0000"><strong>Vàng&nbsp;bí ẩn</strong></span><strong>:</strong><strong>&nbsp;Là một số lượng vàng bí ẩn.</strong></span></p>

            					<p><span style="font-size:20px"><strong><span style="color:#ff0000">x99 thỏi vàng</span>: Là 3tỉ7 vàng.</strong></span></p>

            					<p><span style="font-size:20px"><strong><span style="color:#66ff00">ĐẶC BIỆT</span>: KHÔNG CÓ TỈ LỆ QUAY TRƯỢT.</strong></span></p>

            					<p><span style="font-size:20px"><strong>Chúc anh em quay trúng được nhiều vàng&nbsp;nhé!</strong></span></p>
